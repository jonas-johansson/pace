...
export const BUILT_IN_THEMES: Record<string, TuiTheme> = {
  dark: {
    ...
    blocks: {
      ...
      assistant: { fg: 231, bg: 234, accent: 221, bold: 215 },
      reasoning: { fg: 245, bg: 234, accent: 179, bold: 179 },
      tool: { fg: 231, bg: 235, accent: 117, bold: 230 },
    ...
    overlay: { bg: 235, chromeBg: 237, selBg: 238, fg: 231, dimFg: 244, brightFg: 231 },
    suggestion: { bg: 235 },
    status: { bg: 235, fg: 231, runningFg: 229, contextFg: 245, contextWarnFg: 217, costFg: 187, modelFg: 109 },
    input: { bg: 236, bashBg: 237, fg: 231, bashFg: 179 },
